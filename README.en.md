...
The project is free software licensed under [GPL-3.0-or-later](LICENSE). Version 0.6.0 is a complete but currently unsigned release. Windows Smart App Control or SmartScreen may block an unsigned executable; the project does not recommend disabling Windows security. See the public [Code signing policy](docs/CODE_SIGNING_POLICY.md).
...
- Selenium Standalone management, Firefox WebDriver, session limits, and session termination;
